...
using SalesWebAppMVC.Models.Enums;
...
namespace SalesWebAppMVC.Data
{
    public class SeedService
    {
        ...
        public SeedService(SalesWebAppMVCContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            if (_context.Departmant.Any() || _context.SalesRecord.Any() || _context.Seller.Any())
            {// o banco de dados já está populado.
                return;
            }

            Departmant d1 = new Departmant(1, "Computers");
            Departmant d2 = new Departmant(2, "Eletronics");
            Departmant d3 = new Departmant(3, "Fashion");
            Departmant d4 = new Departmant(4, "Books");
            ...
            _context.Departmant.AddRange(d1, d2, d3, d4);
